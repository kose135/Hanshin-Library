...
import com.example.hanshinlibrary.FacilityNoticeAllListActivity;
...
public class FacilityNoticeFragment extends Fragment {
    private LinearLayout layoutMore;
    private RecyclerView facilityNoticeRecyclerView;
    private SwipeRefreshLayout facilityNoticeSwipeRefreshLayout;

    private facilityNoticeRecyclerViewAdapter facilityNoticeRecyclerViewAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_facilitynotice, container, false);

        layoutMore = (LinearLayout) view.findViewById(R.id.layoutMore);
        layoutMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), FacilityNoticeAllListActivity.class));
            }
        });

        facilityNoticeRecyclerViewAdapter = new facilityNoticeRecyclerViewAdapter();

        facilityNoticeRecyclerView = (RecyclerView) view.findViewById(R.id.facilityNoticeRecyclerView);
        facilityNoticeRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        facilityNoticeRecyclerView.setAdapter(facilityNoticeRecyclerViewAdapter);

        facilityNoticeSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.facilityNoticeSwipeRefreshLayout);
        facilityNoticeSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                facilityNoticeRecyclerViewAdapter.getNoticeCall();
                facilityNoticeSwipeRefreshLayout.setRefreshing(false);
            }
        });
    ...
    private class facilityNoticeRecyclerViewAdapter extends RecyclerView.Adapter {
        ...
        public facilityNoticeRecyclerViewAdapter() {
            getNoticeCall();
        }
        ...
        private class NoticeViewHolder extends RecyclerView.ViewHolder {
            ...
            public NoticeViewHolder(View view) {
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent NoticeActivity = new Intent(getActivity(), com.example.hanshinlibrary.NoticeActivity.class);
