...
import com.example.hanshinlibrary.AcademicNoticeActivity;
import com.example.hanshinlibrary.AcdemicNoticeAllListActivity;
...
public class AcademicNoticeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_academicnotice, container, false);

        layoutMore = (LinearLayout) view.findViewById(R.id.layoutMore);
        layoutMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), AcdemicNoticeAllListActivity.class));
            }
        });
        ...
        private class NoticeViewHolder extends RecyclerView.ViewHolder {
            ...
            public NoticeViewHolder(View view) {
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent AcademicNoticeActivity = new Intent(getActivity(), AcademicNoticeActivity.class);
